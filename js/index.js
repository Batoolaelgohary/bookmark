...
function displayData(){
    ...
    for(var i=0;i<bookmarkList.length;i++){
        ...
        <button class="btn text-capitalize btn-outline-warning"> <i class="fa-solid fa-eye"></i> visit</button>
        </a>
        
        </td>
        <td>
          <button onclick="deleteData(${i})" class="btn text-capitalize btn-outline-danger "><i class="fa-regular fa-trash-can"></i> delete</button>
        </td>
      </tr>`
    }
